...
! function(e, t, i) {
    ...
    function s(t) {
        ...
        var i = e(this).children(),
            ...
            c = "undefined" != typeof t.data("customarrows"),
            p = "undefined" != typeof t.data("slidesspacing") ? parseInt(t.data("slidesspacing")) : 0,
            u = "undefined" != typeof t.data("fullscreen"),
            h = t.data("imagescale"),
            m = "undefined" != typeof t.data("visiblenearby") ? !0 : !1,
            f = "undefined" != typeof t.data("imagealigncenter"),
            g = "undefined" != typeof t.data("slidertransition") && "" != t.data("slidertransition") ? t.data("slidertransition") : "move",
            v = "undefined" != typeof t.data("sliderautoplay") ? !0 : !1,
            w = "undefined" != typeof t.data("sliderdelay") && "" != t.data("sliderdelay") ? t.data("sliderdelay") : "1000",
            y = !0,
            b = "undefined" != typeof t.data("showcaptions") ? !0 : !1,
            x = t.hasClass("header--slideshow") ? !0 : !1,
            _ = "undefined" != typeof t.data("hoverarrows");
    ...
    function l(t) {
        var i = t,
            a = t.data(),
            o = i.find("img"),
            n = e('<div class="pixslider js-pixslider">');
    ...
    function m(t) {
        ...
        i = "undefined" != typeof t ? t.find(".gmap") : e(".gmap"), i.length && "undefined" != typeof google && (globalDebug && console.log("GMap Init"), i.each(function() {
            var t, i = e(this),
                a = i.data("url"),
                o = "undefined" != typeof i.data("customstyle") ? "style1" : google.maps.MapTypeId.ROADMAP,
                n = [],
                r = i.data("markercontent");
            a && (t = h(a), "undefined" == typeof variables && (t = a.split("!3d")[0] !== a ? p(a) : u(a)), "undefined" != typeof t && t.latitude && t.longitude && n.push({
                ...
                options: {
                    content: '<div class="map__marker-wrap"><div class="map__marker">' + r + "</div></div>"
                }
            })), n.length && i.gmap3({
                map: {
                    options: {
    ...
    function f(t) {
        ...
        i = "undefined" != typeof t ? t.find(".gmap--multiple-pins") : e(".gmap--multiple-pins"), i.empty(), $imageMarkup = e(".js-map-pin"), $imageMarkup.length > 0 && ($imageMarkup = e($imageMarkup[0]).html()), i.length && "undefined" != typeof google && (globalDebug && console.log("GMap Multiple Pins Init"), i.each(function() {
            var t, i = e(this),
                a = "undefined" != typeof i.data("customstyle") ? "style1" : google.maps.MapTypeId.ROADMAP,
                o = [],
                n = 10;
            if (t = i.data("pins"), e.each(t, function(e, t) {
                    ...
                    t && (i = h(t), "undefined" == typeof variables && (i = t.split("!3d")[0] !== t ? p(t) : u(t)), "undefined" != typeof i && i.latitude && i.longitude && o.push({
                        ...
                        options: {
                            content: '<div class="gmap__marker"><div class="gmap__marker__btn">' + e + "</div>" + $imageMarkup + "</div>"
                        }
                    }))
                }), o.length) {
    ...
    function v() {
        ...
        if (a && !Modernizr.touch && !is_mobile_ie && !is_OSX) {
            var o = e(t);
    ...
    function w(i, a) {
        ...
        var o = Math.abs(Q - i),
            n = a * o / 2e3;
        pixGS.TweenMax.to(e(t), n, {
            scrollTo: {
                y: i,
                autoKill: !0,
                ease: pixGS.Quint.easeInOut
            }
        })
    }
    ...
    function y() {
        e(".js-nav-trigger").on("click", function(t) {
            ...
            var i = e("html");
            i.hasClass("navigation--is-visible") ? (e("body").css("overflow", ""), i.removeClass("navigation--is-visible")) : (e("body").css({
                overflow: "hidden"
            }), i.addClass("navigation--is-visible"), i.is(".is--ancient-android, .is--winmob, .is--ie") && e(".navigation--main").height(windowHeight))
        })
    }
    ...
    function _() {
        globalDebug && console.group("Init"), touch = !1, ("undefined" != typeof isIe || !t.ActiveXObject && "ActiveXObject" in t) && e("html").addClass("is--ie"), a(), o(), I(), (is_android || t.opera) && e("html").addClass("android-browser").removeClass("no-android-browser");
        var i = A();
    ...
    function O() {
        q = !1, P.update(), R.update(), j.update(), L.update(), $.update()
    }
    ...
    function G() {
        e(".error404").css("background-image", "url(" + D() + ")")
    }

    function I() {
        t.addthis && (globalDebug && console.log("AddThis Load Script"), addthis.addEventListener("addthis.ready", H), addthis.init())
    }

    function H() {
        globalDebug && console.log("AddThis Ready"), E()
    }
    ...
    var P = {
            ...
            initialize: function() {
                var t = this;
                return B = e(document).height(), !Modernizr.touch && !A() || this.initialized ? (this.stop = B - windowHeight, this.amount = W.data("parallax-speed") || .5, this.initialized = !0, e(".covers").empty(), void e(".article__parallax").each(function(i, a) {
                    var o, n, s, l, d, c = e(a),
                        p = c.parent(),
                        u = c.clone(!0).wrap("div.article__header"),
                        h = u.find(".article__parallax__img"),
                        g = u.find(".article__parallax__slider"),
                        v = p.outerHeight(),
                        w = p.offset(),
                        y = c.children(),
                        b = u.children(".article__parallax__img, .article__parallax__slider, .gmap--multiple-pins, .gmap"),
                        x = y.outerWidth(),
                        _ = y.outerHeight(),
                        T = (parseInt(N.css("marginTop")), t.amount),
                        S = {
                            "static": 0,
                            slow: .25,
                            medium: .5,
                    ...
                    C.timeline.fromTo(b, 1, {
                        y: "-=" + v * T
                    }, {
                        y: "+=" + v * T * 2,
                        ease: pixGS.Linear.easeNone,
                        force3D: !0
                    }), C.timeline.fromTo(g.find(".hero__content, .hero__caption"), 1, {
                        y: "+=" + windowHeight * T
                    }, {
                        y: "-=" + windowHeight * T * 2,
                        ease: pixGS.Linear.easeNone,
                        force3D: !0
                    }, "-=1"), k.timeline.fromTo(u, 1, {
                        y: "+=" + w.top
                    }, {
                        y: "-=" + B,
                        ease: pixGS.Linear.easeNone
                    }), u.data("parallax", C).data("parallax2", k), t.update(), r(u), m(u), f(u), t.initialized && pixGS.TweenMax.to(u, .3, {
                        opacity: 1
                    })
                })) : void e(".article__parallax").each(function(t, i) {
                    var a = e(i).closest(".article__header"),
                        o = a.children(".article__parallax"),
                        n = o.find(".article__parallax__img");
                    if (o.show(), n.length) {
                        var s = n.css("width", "auto").outerWidth(),
                            l = n.outerHeight(),
                            d = a.outerHeight(),
                            c = windowWidth / s;
                    ...
                    pixGS.TweenMax.to(o, .3, {
                        opacity: 1
                    }), a.hasClass("half-height") ? a.css("min-height", windowHeight / 2) : a.hasClass("two-thirds-height") ? a.css("min-height", 2 * windowHeight / 3) : a.css("min-height", windowHeight), r(o), m(o), f(o)
                })
            },
            update: function() {
                Modernizr.touch || is_ie || Q > this.stop || Q < this.start || e(".covers .article__parallax").each(function(t, i) {
                    var a = e(i),
                        o = a.data("parallax"),
                        n = a.data("parallax2"),
                        r = (Q - o.start) / (o.end - o.start),
                        s = (Q - n.start) / (n.end - n.start);
        ...
        $ = {
            ...
            initialize: function() {
                var t = this;
                this.$arrow = e(this.selector), empty(this.$arrow) || (this.start = 0, this.end = this.start + 300, this.timeline = new pixGS.TimelineMax({
                    paused: !0
                }), this.$next = this.$arrow.closest(".article__header").nextAll(".article__header, .article--page").first(), empty(this.$next) || (this.nextTop = this.$next.offset().top, this.nextHeight = this.$next.outerHeight()), this.$arrow.hasClass("down-arrow--bubble") ? (this.timeline.to(this.$arrow, .2, {
                    y: 10,
                    opacity: 0,
                    ease: pixGS.Linear.easeNone,
                    overwrite: "none"
        ...
        L = {
            ...
            initialize: function() {
                ...
                empty(t) || (t.data("offsetTop", i), this.timeline = new pixGS.TimelineMax({
                    paused: !0
            ...
            update: function() {
                var t = e(".btn--top"),
                    i = t.data("offsetTop"),
                    a = e(".copyright-area").outerHeight(),
                    o = i - windowHeight + 3 * a / 4;
        ...
        R = {
            ...
            initialize: function() {
                ...
                e(this.selector).each(function(i, a) {
                    var o = e(a),
                        n = o.find(".article__headline"),
                        r = new pixGS.TimelineMax({
                            paused: !0
                        }),
                        s = n.find(".headline__primary"),
                        l = n.find(".headline__secondary"),
                        d = n.find(".headline__description"),
                        c = n.find(".star"),
                        p = n.find(".line"),
                        u = d.find(".arrow"),
                        h = d.find("hr"),
                        m = o.offset().top,
                        f = o.outerHeight();
                    o.find(".pixcode--separator").width(s.width()), d.css({
                        opacity: 1
                    }), d = d.children().not(".pixcode--separator"), d.css({
                        opacity: 0
                    }), r.fromTo(s, .72, {
                        "letter-spacing": "1em",
                        "margin-right": "-0.9em"
                        ...
                        y: 0
                    }, "-=0.5"), r.addLabel("animatedIn"), r.fromTo(s, 1.08, {
                        y: 0
                    }, {
                        opacity: 0,
                        y: -60,
                        ...
                        opacity: 0
                    }, "-=1.08"), r.addLabel("animatedOut");
                    var g, v, w = r.getLabelTime("animatedIn"),
                        y = r.getLabelTime("animatedOut"),
                        b = m + f / 2 - wh / 2,
                        x = b + f / 2;
        ...
        j = {
            ...
            initialize: function() {
                ...
                if (this.initialized = !0, this.$sections = e(t.sectionSelector), this.footer = e(".sidebar--footer__dark"), this.footer.length && (this.footerTop = this.footer.offset().top), !(this.$sections.length < 2)) {
                    for (var a = 0; a < this.$sections.length; a++) {
                        ...
                        o.next().is(".article--page") && (t.nextTop += o.next().outerHeight()), s.appendTo(i), s.data("scrollTo", n - windowHeight / 2 + r / 2), o.data("offsetTop", n),
                            function(e) {
                    ...
                    this.$selected = e('<div class="navigator__item  navigator__item--selected"><div class="bullet"></div></div>').appendTo(i), this.$selectedBullet = this.$selected.find(".bullet"), this.timeline.add(pixGS.TweenMax.to(t.$selectedBullet, 0, {})), this.timeline.add(pixGS.TweenMax.to(t.$selectedBullet, .1, {
                        ...
                        scaleY: 1,
                        scaleX: 1
                    })), this.timeline.add(pixGS.TweenMax.to(t.$selectedBullet, 0, {
                        scale: 1.2
                    })), i.css({
                    ...
                    }), i.hasClass("navigator--transparent") ? pixGS.TweenMax.to(i, 2, {
                        opacity: .2
                    }) : pixGS.TweenMax.to(i, .3, {
                        opacity: 1
                    })
                }
            },
            update: function() {
                ...
                }), 0 != this.footerTop && this.footerTop < Q + windowHeight / 2 && (this.isWhite = !0), this.lastSelected != this.currentSelected && (this.lastSelected = this.currentSelected, pixGS.TweenMax.to(this.$selected, .3, {
    ...
    e(document).ready(function() {
        ...
        e(".pixcode--tabs").organicTabs(), $.initialize(), setTimeout(function() {
            j.initialize(), L.initialize()
        }, 60)
    }), e(t).on("debouncedresize", function() {
        globalDebug && console.group("OnResize"), windowWidth = e(t).width(), windowHeight = e(t).height(), x(), r(e(".js-pixslider").not(".article__parallax .js-pixslider")), L.initialize(), P.initialize(), R.initialize()
    }), e(t).on("organicTabsChange", function() {
        L.initialize(), P.initialize(), R.initialize()
    }), e(t).on("orientationchange", function() {
        setTimeout(function() {
            P.initialize(), R.initialize()
        }, 300)
    });
    var Q = e("body").scrollTop() || e("html").scrollTop(),
        q = !1;
